...
| Folder | Description |
|--------|-------------|
| `bpe/` | Code for training a **Byte Pair Encoding (BPE)** vocabulary and for encoding GT with vocabularies of musical words. |
...
| `omr/` | Code to train **Optical Music Recognition** models with the PyLaia tool. |
